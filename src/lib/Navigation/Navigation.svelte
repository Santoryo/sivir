...
<nav class="list-nav p-4 font-semibold uppercase" data-sveltekit-preload-data="hover">
	<ul>
        <li><a href="/" on:click={drawerClose}><i class='nav-icon' style='background-image: url("/home.png")'></i> home</a></li>
